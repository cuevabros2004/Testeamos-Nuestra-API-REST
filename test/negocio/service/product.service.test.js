...
import { productoServicio } from '../../../src/services/productoService.js'
...
describe('pruebo mi servicio de productos', () => {
    ...
    after(async () => {
        ...
        it('actualización de un producto', async () => {
            ...
            const id = '8e4e034f-f222-4fc3-99a0-82697bc0d4e1'
           ...
           const existe =  await productoServicio.listarProductoPorId({"_id": id})
    ...
    it('eliminación de un producto', async () => {
        ...
        const id = '61be3550-0d47-4a43-ad94-44fafdbee00f'
